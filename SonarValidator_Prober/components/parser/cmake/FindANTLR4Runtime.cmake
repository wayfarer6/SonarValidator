...
#  ANTLR4 C++ 런타임 탐색
#
#  문법에서 생성한 파서 소스(components/parser/generated)는 저장소에 커밋되어
#  있으므로, 일반 빌드에는 "런타임 라이브러리 + 헤더" 만 있으면 된다.
#  (jar 는 문법을 다시 생성할 때만 필요하다 — regenerate_parser.sh 참고)
#
#  탐색 순서
...
#  상위 CMakeLists 가 ANTLR 의존 타깃을 만들지 않도록 한다.
# =============================================================================
...
if(ANTLR4_RUNTIME_ROOT)
    ...
    if(SONAR_ANTLR4_RUNTIME_LIB)
        ...
        if(ANTLR4_JAR)
            message(STATUS "ANTLR4: jar=${ANTLR4_JAR} (문법 재생성 시에만 필요)")
        endif()
    else()
        message(STATUS "ANTLR4: runtime library not found under ${ANTLR4_RUNTIME_ROOT}")
    endif()
else()
    message(STATUS "ANTLR4: runtime not found (jar=${ANTLR4_JAR} root=${ANTLR4_RUNTIME_ROOT})")
endif()
