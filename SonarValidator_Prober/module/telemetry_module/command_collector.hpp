#ifndef SONAR_VALIDATOR_PROBER_TELEMETRY_COMMAND_COLLECTOR_HPP_
#define SONAR_VALIDATOR_PROBER_TELEMETRY_COMMAND_COLLECTOR_HPP_
...
#endif // SONAR_VALIDATOR_PROBER_TELEMETRY_COMMAND_COLLECTOR_HPP_
